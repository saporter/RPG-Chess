...
public class Cardinal : MonoBehaviour, IChessPiece
{
    ...
    public List<int> AvailableMoves(List<GameObject> board, int currentPos)
    {
        ...
        moves.AddRange(Library.MoveInLine(board, currentPos, 1, 0, Team, 1));
        moves.AddRange(Library.MoveInLine(board, currentPos, -1, 0, Team, 1));
        moves.AddRange(Library.MoveInLine(board, currentPos, 0, 1, Team, 1));
        moves.AddRange(Library.MoveInLine(board, currentPos, 0, -1, Team, 1));

        moves.AddRange(Library.MoveInLine(board, currentPos, 1, 1, Team, 100));
        moves.AddRange(Library.MoveInLine(board, currentPos, -1, -1, Team, 100));
        moves.AddRange(Library.MoveInLine(board, currentPos, 1, -1, Team, 100));
        moves.AddRange(Library.MoveInLine(board, currentPos, -1, 1, Team, 100));
